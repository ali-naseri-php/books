    ...
    <style>
        ...
        *, ::before, ::after {
        ...
        .drop-shadow-\[0px_4px_34px_rgba\(0\2c 0\2c 0\2c 0\.06\)\] {
            --tw-drop-shadow: drop-shadow(0px 4px 34px rgb(187, 192, 192));
        ...
        @media (prefers-color-scheme: dark) {
            ...
            .dark\:via-zinc-900 {
                ...
                --tw-gradient-stops: var(--tw-gradient-from), #bbc0c0 var(--tw-gradient-via-position), var(--tw-gradient-to)
            }

            .dark\:to-zinc-900 {
                --tw-gradient-to: #bbc0c0 var(--tw-gradient-to-position)
            }
                ...
                @if (Route::has('login'))
                    <nav class="-mx-3 flex flex-1 justify-end">
                        ...
                        @else
                            <a
                                href="{{ route('login') }}"
                                class="rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-black/80 dark:focus-visible:ring-black"
                            >
                                Log in
                            </a>
                    ...
                    <section class="section about" id="about" aria-label="about">
                        <div class="container">
                            ...
                            <p class="section-text">
                                ...
                                you arrive
                                inevitably at the egg. Likewise, starting with the egg and following the same process in
                                reverse, one
                                finishes with the
                                portrait.
                            </p>
                            ...
                            <div class="title-wrapper">
                                ...
                                <ul class="filter-btn-list">
                                    ...
                                    <li class="filter-btn-item">
                                        <button class="filter-btn active" data-filter-btn="all">All book with time</button>
                                    </li>
...
@foreach($data as $book)
                                ...
                                <li class="decoration">
                                    <div class="product-card">
                                        ...
                                        <a href="#" class="card-banner img-holder has-before"
                                           style="--width: 300; --height: 300;">
                                            <img src="{{url('images/'.$book->image)}}" width="300" height="300" loading="lazy"
                                            ...
                                            <ul class="card-action-list">
                                                ...
                                                <li>
                                                    <form action="{{ url('books/add/'.$book->id)}}"method="get">
                                        ...
                                        <div class="card-content">
                                            ...
                                            <h3 class="h3">
                                                <button type="submit" class="card-title">{{$book->name}}</button>
                                            </h3>
                                            </form>
                                            <div class="card-price">
                                                @php
                                                    $price =$book->price+$book->price*10/100 @endphp
                                                <del class="del">{{$price}}</del>

                                                <data class="price" value="10">{{$book->price}}</data>
                                            </div>
                                        </div>
